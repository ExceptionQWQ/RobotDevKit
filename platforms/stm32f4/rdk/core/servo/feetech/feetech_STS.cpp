...
FeetechSTS::FeetechSTS(std::shared_ptr<FeetechProtocol> fee, uint8_t id) : Servo(id)
{
    this->fee = fee;
}

FeetechSTS::~FeetechSTS()
{
 ...
 */
void FeetechSTS::torque_switch(bool value)
{
 ...
 * @return position
 */
int16_t FeetechSTS::read_position()
{
    int16_t pos = 0;
 ...
 * @return position
 */
int16_t FeetechSTS::read_position_cache()
{
 ...
 * @param position
 */
void FeetechSTS::write_position(int16_t position)
{
 ...
 * @param speed 步/s
 */
void FeetechSTS::write_position_speed(int16_t position, uint16_t speed)
{
